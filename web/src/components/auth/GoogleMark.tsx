/**
 * The four-colour Google "G", drawn to Google's sign-in branding spec. These
 * are Google's own brand colours, not ours — the design-token rule doesn't
 * apply to a third party's mark.
 */
